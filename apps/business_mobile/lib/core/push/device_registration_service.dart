...
/// Registers business app install in FoodApp `user_devices` after login.
class DeviceRegistrationService {
  ...
  Future<void> registerAfterAuth() async {
    ...
    try {
      ...
      debugPrint('Business device registration failed: $e');
    }
  }
  ...
  Future<void> unregisterOnLogout() async {
    try {
      ...
      debugPrint('Business device unregister failed: $e');
    }
  }
