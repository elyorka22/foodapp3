  ...
  Future<void> _promptForNotificationPermissionIfNeeded() async {
    ...
    await showDialog<void>(
      ...
      builder: (ctx) => AlertDialog(
        title: const Text(AppStrings.pushPermissionTitle),
        content: const Text(AppStrings.pushPermissionBody),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(ctx),
            child: const Text(AppStrings.pushPermissionLater),
          ),
          FilledButton(
            onPressed: () async {
              Navigator.pop(ctx);
            ...
            child: const Text(AppStrings.pushPermissionEnable),
          ),
        ],
      ),
    );
