...
export const uz = {
  ...
  locationAuto: 'Avtomatik',
  detectingLocation: 'Aniqlanmoqda...',
  deliveryAddressRequired: 'Yetkazish manzilini kiriting.',
  locationAutoFailed: 'Joylashuvni aniqlab bo\'lmadi. Qo\'lda rejimni tanlang yoki manzilni aniqroq yozing.',
  addressNotResolved: 'Manzil topilmadi. Manzilni aniqroq yozing.',
